...
use App\Services\Zatca\Tags\{Seller, TaxNumber, PublicKey, InvoiceTotalAmount, InvoiceTaxAmount, InvoiceHash, InvoiceDigitalSignature, InvoiceDate, CertificateSignature};
 ...
 *
 * @package AApp\Services\Zatca\Helpers
 */
class InvoiceExtension
{
